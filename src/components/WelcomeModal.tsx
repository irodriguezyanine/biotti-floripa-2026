      ...
      {visible && (
        ...
        >
            ...
            <p className="font-body text-lg sm:text-xl md:text-2xl text-white leading-relaxed mb-10">
              QUEDAN <span className="font-bold text-amber-300">{days}</span> DÍAS PARA PODER DESPEDIR A NUESTRO AMIGO COMO CORRESPONDE
            </p>
            <motion.button
              onClick={handleEnter}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="px-12 py-4 rounded-xl font-display text-xl tracking-wider text-white shadow-lg transition-colors hover:opacity-90"
              style={{ backgroundColor: "#6CB26D" }}
            >
              ENTRAR
            </motion.button>
          </motion.div>
